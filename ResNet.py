...
# function defining a convolution layer for the network with a fixed filter size of 3x3
def conv3x3(in_channels, out_channels, stride = 1):
    return nn.Conv2d(in_channels, out_channels, kernel_size = 3, stride = stride, padding = 1, bias = False)

# This class defines a residual block that consists of two convolutional layers
...
class ResNet(nn.Module):
    ...
    # for example: [2, 2, 2]
    def __init__(self, block_type, blocks, classes = 5):
    ...
    # this method creates the layers of residual blocks needed for the network
